		              ...
		              <div class="panel panel-default">
			              <div class="panel-heading" style="font-weight: bold; font-size: 20pt; font: NANUM;">
			              	<i class="fa fa-comments fa-fw"></i> 문의　　　　　　　　　　　　　　　　　　　　　　　　
			              		<button id="addQnaBtn" class="detail-btn" style="color: #000; font: 14px Poppins, sans-serif; background: #fff; padding: 1px 6px; width:100px;height:50px; border:1px solid blue; border-radius: 10px; background-color: white;"> 문의 등록</button>
			              </div>
     	...
     	<div class="modal-dialog">
     		<div class="modal-content">
     			...
     			<div class="modal-footer">
     				...
     				<button id="modalCloseBtn" type="button" data-dismiss="modal" class="btn btn-default">닫기</button>
     				<button id="modalRegisterBtn" type="button" data-dismiss="modal" class="btn btn-default">등록</button>
     			</div>
     		</div>
     	</div>
     </div>
